...
_SIMULATE_HOSTINFO = {
    4: {
        ...
        "is_campus": True,
        "user_device": {
            "browser": "Chrome", "browser_version": "125.0.0",
            "os": "Mac OS X", "os_version": "10.15.7",
        ...
        "iplocation": {
            "country_code2": "US", "country_name": "United States",
            "ip": "192.0.2.50", "ip_number": None, "ip_version": 4,
            "isp": "University of North Carolina at Chapel Hill",
            "org": "University of North Carolina at Chapel Hill",
            "asn": "AS36105", "region": "North Carolina", "response_code": None,
            "response_message": None, "city": "Chapel Hill",
            "lat": 35.9049, "lon": -79.0469,
            "mobile": False, "proxy": False, "hosting": False,
        },
        "network": {
            "cidr": "192.0.2.0/24", "comment": "Demo network",
            "ip_version": "4", "netmask": "255.255.255.0", "prefixlen": "24",
            "contact": None, "contact_name": None, "contact_email": None,
            "contact_dept": "ITS", "cost_center": None, "purpose": "Wired",
            "router_device": None, "dhcp_servers": [], "dhcp_routers": None,
            "dhcp_dns_servers": [], "dhcp_domain_name": None,
            "dhcp_lease_time": None, "dhcp_ntp_servers": [],
            "vlan_id": "100", "vlan_name": "ITS-Demo-Users",
        },
        "address_details": {
            "mac": "00:00:5e:00:53:01",
            "names": ["demo-device.net.unc.edu"],
            "types": ["A"], "usage": ["Static"],
            "contact": None, "contact_name": None,
            "contact_email": None, "contact_dept": None,
            "comment": "Demo device",
        },
        "nac": {
            "endSystem": {
    ...
    6: {
        ...
        "iplocation": {
            "country_code2": "US", "country_name": "United States",
            "ip": "2001:db8::50", "ip_number": None, "ip_version": 6,
            "isp": "University of North Carolina at Chapel Hill",
            "org": "University of North Carolina at Chapel Hill",
            "asn": "AS36105", "region": "North Carolina", "response_code": None,
            "response_message": None, "city": "Chapel Hill",
        ...
        "network": {
            "cidr": "2001:db8::/32", "comment": "Demo IPv6 network",
            "ip_version": "6", "netmask": None, "prefixlen": "32",
            "contact": None, "contact_name": None, "contact_email": None,
            "contact_dept": "ITS", "cost_center": None, "purpose": "Wired",
            "router_device": None, "dhcp_servers": [], "dhcp_routers": None,
            "dhcp_dns_servers": [], "dhcp_domain_name": None,
