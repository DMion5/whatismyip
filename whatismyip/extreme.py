# https://documentation.extremenetworks.com/XIQ-SE_API/GraphQLschema/
# https://github.com/extremenetworks/ExtremeScripting/blob/master/XMC_XIQ-SE/nbi_clients/Python3/XMC_NBI.py
