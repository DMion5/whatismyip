...
_SIMULATE_HOSTINFO = {
    4: {
        ...
        "ptr": "demo-device.net.buffalo.edu",
        "iplocation": {
            "country_code2": "US",
        ...
        "address_details": {
            ...
            "names": ["demo-device.net.buffalo.edu"],
            "types": ["A"],
            "usage": ["Static"],
            "contact": None,
            "contact_name": None,
